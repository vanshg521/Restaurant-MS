...
class ReservationForm extends React.Component {
    ...
    for (var id in fieldsId) {
        ...
        if(!errors[fieldsId[id]]){
            errors[fieldsId[id]] = '';
        }
    }
    console.log(this.props.reservation[fieldsId.txtDate]);
        return (
            <React.Fragment>
                <Grid container spacing={24}>
                    <Grid item xs={12} sm={6}>
                        <TextField
                            ...
                            error={errors[fieldsId.txtName].length > 0}
                            helperText={errors[fieldsId.txtName]}
                    ...
                    <Grid item xs={12} sm={6}>
                        <TextField
                            ...
                            onChange={this.props.handleTextChange}
                            error={errors[fieldsId.txtPhone].length > 0}
                            helperText={errors[fieldsId.txtPhone]}
                            InputProps={{
                                startAdornment: (
                                    <InputAdorment position="start">
                                        <PhoneIcon />
                    ...
                    <Grid item xs={12} sm={6}>
                        <TextField
                            ...
                            onChange={this.props.handleTextChange}
                            error={errors[fieldsId.txtEmail].length > 0}
                            helperText={errors[fieldsId.txtEmail]}
                            InputProps={{
                                startAdornment: (
                                    <InputAdorment position="start">
                                        <EmailIcon />
                    ...
                    <Grid item xs={12} sm={6}>
                        <TextField
                            ...
                            error={errors[fieldsId.txtDate].length > 0}
                            helperText={errors[fieldsId.txtDate]}
                            onChange={this.props.handleTextChange}
                            InputLabelProps={{
                                shrink: true,
                            }}
                    ...
                    <Grid item xs={12} >
                        <TextField
                            ...
                            error={errors[fieldsId.txtNotes].length > 0}
                            helperText={errors[fieldsId.txtNotes]}
                            onChange={this.props.handleTextChange}
                            InputProps={{
                                startAdornment: (
                                    <InputAdorment position="start">
